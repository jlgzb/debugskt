...
from ..core import EvalHook # by gzb
...
def train_model(model,
    ...
    dataloader_setting = dict(
        ...
        num_gpus=len(cfg.gpu_ids), # by gzb
        dist=distributed, # by gzb
        seed=cfg.seed)
    ...
    #runner.register_hook(DistSamplerSeedHook()) # ori
    if distributed:
        runner.register_hook(DistSamplerSeedHook()) # by gzb
