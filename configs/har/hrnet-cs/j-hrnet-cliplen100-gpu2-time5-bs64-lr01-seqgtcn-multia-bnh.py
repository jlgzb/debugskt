model = dict(
    ...
    neck=dict(type='SeqGTCN', in_channels=256, out_channels=256),
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn++/stgcn++_ntu60_xsub_hrnet/j-hrnet-cliplen100-gpu2-time5-bs64-lr01-seqgtcn-multia-bnh'
