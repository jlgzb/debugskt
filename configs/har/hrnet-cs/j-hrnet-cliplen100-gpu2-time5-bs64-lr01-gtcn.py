model = dict(
    ...
    cls_head=dict(type='ParaGTCNHead', num_classes=60, in_channels=512))
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn++/stgcn++_ntu60_xsub_hrnet/j-hrnet-cliplen100-gpu2-time5-bs64-lr01-gtcn'
